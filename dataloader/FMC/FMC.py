...
def get_inc_list():
    with open("data/FSD_MIX_CLIPS.audio/single_lable_1s_clips/filelist/single_label_val_filelist.json", 'r') as json_file:
        fileval = json.load(json_file)
        dataval = fileval['data']
        labelsval = fileval['labels']
    with open("data/FSD_MIX_CLIPS.audio/single_lable_1s_clips/filelist/single_label_test_filelist.json", 'r') as json_file:
        filetest = json.load(json_file)
        datatest = filetest['data']
        labelstest = filetest['labels']
    with open("data/FSD_MIX_CLIPS.audio/single_lable_1s_clips/filelist/single_label_inc_filelist.json", 'w') as json_file:
        inc_dict= {}
        datainc = dataval + datatest
        labelsinc = labelsval + labelstest
        inc_dict['data'] = datainc
        inc_dict['labels'] = labelsinc
        json.dump(inc_dict, json_file)
