...
def base_train(model, trainloader, optimizer, scheduler, epoch, args):
    ...
    for i, batch in enumerate(tqdm_gen, 1):
        ...
        #proto_layer2,query_layer2=data_layer2[:bse_idx], data_layer2[bse_idx:bqe_idx]
        ...
        logits, anchor_loss, pqa_query, pqa_proto,_,_ = model.module._forward(proto, query,args.stdu.pqa, sup_emb=sup_emb, novel_ids=novel_ids)
