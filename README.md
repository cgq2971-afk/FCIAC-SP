...
run experiment
```
python train.py  -dataroot DATAROOT -dataset librispeech -config ./configs/LS-100_FCIAC -gpu 0
python train.py  -dataroot DATAROOT -dataset nsynth-100 -config ./configs/Nsynth100_FCIAC.yml -gpu 0
python train.py  -dataroot DATAROOT -dataset FMC -config ./configs/Fmc89_FCIAC.yml -gpu 0
```
## Contact
